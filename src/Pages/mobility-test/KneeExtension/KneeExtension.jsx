...
const KneeExtension
 = () => {
  ...
  const handleExpire = useCallback(() => {
    setIsTracking(false);
    side === 'left' ? localStorage.setItem('name', "Report Estensione Ginocchio Sinistro") : localStorage.setItem('name', "Report Estensione Ginocchio Destro");
