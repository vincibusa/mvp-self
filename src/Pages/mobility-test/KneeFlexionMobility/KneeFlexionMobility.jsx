...
const KneeFlexionMobility = () => {
  ...
  const handleExpire = useCallback(() => {
    setIsTracking(false);
    side === 'left' ? localStorage.setItem('name', "Report Flessione Ginocchio Sinistro") : localStorage.setItem('name', "Report Flessione Ginocchio Destro");
  ...
  if (!side) {
    return <SideSelectionModal onSelect={setSide} exerciseType="Knee Flexion" />;
  }
  return (
...
export default KneeFlexionMobility;