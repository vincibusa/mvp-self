...
const ShoulderFlexion = () => {
  ...
  const handleExpire = useCallback(() => {
    setIsTracking(false);
    side === 'left' ? localStorage.setItem('name', "Report Estensione Spalla Sinistra") : localStorage.setItem('name', "Report Estensione Spalla Destra");
  ...
  if (!side) {
    return <SideSelectionModal onSelect={setSide} exerciseType="Shoulder Flexion" />;
  }
  return (
